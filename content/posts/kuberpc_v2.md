+++
title = 'KubeRPC v2: Now Actually Kubernetes-Native'
date = '2026-06-28T00:00:00.000Z'
description = 'KubeRPC v2 ships a mutating admission webhook that eliminates all in-cluster configuration. Your services just work with a single annotation.'
...
Every developer working on every service needed to know about KubeRPC's internals just to use it. That is the opposite of seamless integration, and honestly the opposite of what I set out to build.

The framework was Kubernetes-aware, but not Kubernetes-native.
...
No arguments. No knowledge of the registry URL. No hardcoded hostnames. The webhook handled it.
...
v2 also ships a cleaner call API. Previously:
...
annotations:
  kuberpc.suei.io/enabled: "true"
  kuberpc.suei.io/service: "my-service"
```
...
Call them from any other annotated service:
